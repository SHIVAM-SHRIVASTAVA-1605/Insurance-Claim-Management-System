...
class ClaimDetailScreen extends StatelessWidget {
      ...
      appBar: AppBar(
        ...
        actions: [
          PopupMenuButton<String>(
            ...
            tooltip: 'Export',
            onSelected: (value) => _handleExport(context, claim, value),
  ...
  Future<void> _handleExport(
      BuildContext context, Claim claim, String exportType) async {
    try {
      ...
      if (exportType == 'pdf') {
        await ExportService.exportClaimToPdf(claim);
      } else if (exportType == 'csv') {
        final csv = await ExportService.exportClaimToCsv(claim);
        final filename =
            'claim_${claim.patientId}_${DateTime.now().millisecondsSinceEpoch}.csv';
